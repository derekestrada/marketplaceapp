    ...
    <div className='category'>
      ...
      {loading ? (
        ...
        <>
          ...
          <div id="map" className="mapDetails" style={{height: '300px', overflow:'hidden'}}>
                <MapContainer center={state.coords} zoom={zoom} scrollWheelZoom={false}>
                    <TileLayer
                    ...
                    {listings.map((listing) => (
                      ...
                      <Marker key={listing.id} position={[listing.data.latitude, listing.data.longitude]} icon={mapIcon}>
                        <Popup>
                          <img alt={listing.data.name} style={{width: "100%"}} src={listing.data.imageUrls[0]}/>
