...
function AddCatch() {
  ...
  const [position, setPosition] = useState([
    44.56975401408825, -83.81710052490236,
  ]);
      ...
      <main>
        <form onSubmit={onSubmit}>
          ...
          <div className="formButtons">
            <button
              className={
                lure === "Crankbait" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="lure"
              value="Crankbait"
            ...
            <button
              className={
                lure === "Swimbait" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="lure"
              value="Swimbait"
            ...
            <button
              className={
                lure === "Spinner Bait" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="lure"
              value="Spinner Bait"
            ...
            <button
              className={
                lure === "Chatter Bait" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="lure"
              value="Chatter Bait"
            ...
            <button
              className={
                lure === "Livebait" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="lure"
              value="Livebait"
          ...
          <div className="formButtons">
            ...
            <button
              className={
                type === "Trolling" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="type"
              value="Trolling"
            ...
            <button
              className={
                type === "Vertical" ? "formButtonActive" : "formButton"
              }
              type="button"
              id="type"
              value="Vertical"
